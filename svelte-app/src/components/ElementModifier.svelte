<script>
  export let activeElementStyles;
  export let typeOfInput;
...
{:else if typeOfInput === "textColor"}
  <input
    ...
    on:input={updateStyle}
  />
{:else if typeOfInput === "textBackground"}
  <input
  ...
  />
{/if}
<label class="modify-element-text"> <slot /></label>
